...
export default function App() {
  ...
  return (
    <div className="App">
      ...
      <div className="timer" style={{ color: timer >= 56 ? "red" : "lightgreen" }}>{timer} Seconds</div>   <h1>Typing Speed Test</h1>
      <br />
      ...
      <p className="acc" style={{color:accuracy>50?"green":"red"}}> Accuracy: {accuracy.toFixed(2)} %</p>
